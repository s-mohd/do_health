(() => {
  // ../do_health/node_modules/preact/dist/preact.module.js
  var n;
  var l;
  var u;
  var i;
  ...
  // ../do_health/node_modules/preact/hooks/dist/hooks.module.js
  var t2;
  var r2;
  var u2;
  var i2;
  ...
  // ../do_health/node_modules/preact/compat/dist/compat.module.js
  function g3(n2, t3) {
    for (var e3 in t3)
      n2[e3] = t3[e3];
    return n2;
  ...
  // ../do_health/node_modules/@fullcalendar/core/internal-common.js
  var styleTexts = [];
  ...
  function formatWithOrdinals(formatter, args, fallbackText) {
    ...
    if (typeof formatter === "string") {
      return args.reduce((str, arg, index10) => str.replace("$" + index10, arg || ""), formatter);
    }
    return fallbackText;
  }
  ...
  function buildPublicIdMaps(eventStore) {
    const { defs: defs2, instances } = eventStore;
    const defIdMap = {};
    const instanceIdMap = {};
    for (let defId in defs2) {
      const def = defs2[defId];
      const { publicId } = def;
      if (publicId) {
    ...
    for (let instanceId in instances) {
      ...
      const def = defs2[instance.defId];
      const { publicId } = def;
      if (publicId) {
  ...
  var NowTimer = class extends x {
    ...
    computeTiming() {
      ...
      if (nowIndicatorSnap === "auto") {
        nowIndicatorSnap = /year|month|week|day/.test(props.unit) || (props.unitValue || 1) === 1;
      }
      let nowDate;
      let waitMs;
      if (nowIndicatorSnap) {
  ...
  function insertAt(arr, index10, item) {
    arr.splice(index10, 0, item);
  }
  ...
  var DayTableModel = class {
    ...
    sliceRange(range) {
      ...
      if (seriesSeg) {
        ...
        let index10 = firstIndex;
        while (index10 <= lastIndex) {
          let row = Math.floor(index10 / colCnt);
          let nextIndex = Math.min((row + 1) * colCnt, lastIndex + 1);
          segs.push({
            row,
            firstCol: index10 % colCnt,
            lastCol: (nextIndex - 1) % colCnt,
            isStart: seriesSeg.isStart && index10 === firstIndex,
  ...
  var DayCellContainer = class extends BaseComponent {
    ...
    render() {
      ...
      return y(ContentContainer, { elRef: props.elRef, elTag: props.elTag, elAttrs: Object.assign(Object.assign({}, props.elAttrs), renderProps.isDisabled ? {} : { "data-date": formatDayString(props.date) }), elClasses: [
        ...
        ...props.elClasses || []
      ], elStyle: props.elStyle, renderProps, generatorName: "dayCellContent", customGenerator: options.dayCellContent, defaultGenerator: props.defaultGenerator, classNameGenerator: renderProps.isDisabled ? void 0 : options.dayCellClassNames, didMount: options.dayCellDidMount, willUnmount: options.dayCellWillUnmount }, props.children);
    }
  };
  ...
  // ../do_health/node_modules/@fullcalendar/core/index.js
  var globalLocales = [];
  ...
  // ../do_health/node_modules/@fullcalendar/daygrid/internal.js
  var TableView = class extends DateComponent {
    ...
    renderHScrollLayout(headerRowContent, bodyContent, colCnt, dayMinWidth) {
      ...
      return y(
        ViewContainer,
        { elClasses: ["fc-daygrid"], viewSpec: context.viewSpec },
        y(ScrollGrid2, { liquid: !props.isHeightAuto && !props.forPrint, forPrint: props.forPrint, collapsibleWidth: props.forPrint, colGroups: [{ cols: [{ span: colCnt, minWidth: dayMinWidth }] }], sections })
      );
    }
  };
  ...
  // ../do_health/node_modules/@fullcalendar/daygrid/index.js
  ...
  // ../do_health/node_modules/@fullcalendar/list/internal.js
  ...
  // ../do_health/node_modules/@fullcalendar/list/index.js
  var OPTION_REFINERS = {
  ...
  // ../do_health/node_modules/@fullcalendar/timegrid/internal.js
  ...
  var TimeColsView = class extends DateComponent {
    ...
    renderHScrollLayout(headerRowContent, allDayContent, timeContent, colCnt, dayMinWidth, slatMetas, slatCoords) {
      ...
      return y(
        ViewContainer,
        { elRef: this.rootElRef, elClasses: ["fc-timegrid"], viewSpec: context.viewSpec },
        y(ScrollGrid2, { liquid: !props.isHeightAuto && !props.forPrint, forPrint: props.forPrint, collapsibleWidth: false, colGroups: [
  ...
  // ../do_health/node_modules/@fullcalendar/timegrid/index.js
  ...
  // ../do_health/node_modules/@fullcalendar/interaction/index.js
      ...
      for (let id in droppableStore) {
        ...
        if (offsetTracker && offsetTracker.isWithinClipping(offsetLeft, offsetTop)) {
          ...
          if (positionLeft >= 0 && positionLeft < width && positionTop >= 0 && positionTop < height) {
            ...
            if (hit && rangeContainsRange(hit.dateProfile.activeRange, hit.dateSpan.range) && (this.disablePointCheck || offsetTracker.el.contains(offsetTracker.el.getRootNode().elementFromPoint(
  ...
  // ../do_health/node_modules/@fullcalendar/premium-common/index.js
  ...
  // ../do_health/node_modules/@fullcalendar/resource/internal-common.js
  ...
  var ResourceLabelContainer = class extends BaseComponent {
    ...
    render() {
      ...
      return y(ViewContextType.Consumer, null, (context) => {
        ...
        return y(ContentContainer, { elRef: props.elRef, elTag: props.elTag, elAttrs: Object.assign(Object.assign({}, props.elAttrs), { "data-resource-id": props.resource.id, "data-date": props.date ? formatDayString(props.date) : void 0 }), elClasses: props.elClasses, elStyle: props.elStyle, renderProps, generatorName: "resourceLabelContent", customGenerator: options.resourceLabelContent, defaultGenerator: renderInnerContent5, classNameGenerator: options.resourceLabelClassNames, didMount: options.resourceLabelDidMount, willUnmount: options.resourceLabelWillUnmount }, props.children);
      });
    }
  };
  ...
  var ResourceIndex = class {
    constructor(resources) {
      let indicesById = {};
      let ids = [];
      for (let i3 = 0; i3 < resources.length; i3 += 1) {
        let id = resources[i3].id;
        ids.push(id);
        indicesById[id] = i3;
      }
      this.ids = ids;
  ...
  var DayResourceTableModel = class extends AbstractResourceDayTableModel {
    ...
    computeColRanges(dateStartI, dateEndI, resourceI) {
      let segs = [];
      for (let i3 = dateStartI; i3 <= dateEndI; i3 += 1) {
        let col = this.computeCol(i3, resourceI);
        segs.push({
          firstCol: col,
          lastCol: col,
          isStart: i3 === dateStartI,
          isEnd: i3 === dateEndI
        });
      }
      return segs;
  ...
  var VResourceJoiner = class {
    ...
    joinSegs(resourceDayTable, ...segGroups) {
      ...
      let transformedSegs = [];
      for (let i3 = 0; i3 < resourceCnt; i3 += 1) {
        for (let seg of segGroups[i3]) {
          transformedSegs.push(...this.transformSeg(seg, resourceDayTable, i3));
        }
    ...
    joinInteractions(resourceDayTable, ...interactions) {
      ...
      let isEvent = false;
      for (let i3 = 0; i3 < resourceCnt; i3 += 1) {
        let interaction = interactions[i3];
        if (interaction) {
  ...
  var VResourceSplitter = class extends Splitter {
    getKeyInfo(props) {
      ...
      let hash = mapHash(resourceDayTableModel.resourceIndex.indicesById, (i3) => resourceDayTableModel.resources[i3]);
      hash[""] = {};
      return hash;
    }
    getKeysForDateSpan(dateSpan) {
  ...
  // ../do_health/node_modules/@fullcalendar/resource/index.js
  ...
  function applyEventDefMutation(eventDef, mutation, context) {
    ...
    if (resourceMutation && computeResourceEditable(eventDef, context)) {
      let index10 = eventDef.resourceIds.indexOf(resourceMutation.matchResourceId);
      if (index10 !== -1) {
        let resourceIds = eventDef.resourceIds.slice();
        resourceIds.splice(index10, 1);
  ...
  function buildRequestParams2(meta, range, context) {
    let { dateEnv, options } = context;
    let startParam;
    let endParam;
    let timeZoneParam;
  ...
  var index6 = createPlugin({
    ...
    optionChangeHandlers,
    optionRefiners: OPTION_REFINERS5,
    listenerRefiners: LISTENER_REFINERS2,
    propSetHandlers: { resourceStore: handleResourceStore }
  });

  // ../do_health/node_modules/@fullcalendar/resource-daygrid/internal.js
  ...
  // ../do_health/node_modules/@fullcalendar/resource-timegrid/internal.js
  ...
  // ../do_health/node_modules/@fullcalendar/resource-timegrid/index.js
  ...
  // ../do_health/node_modules/@fullcalendar/scrollgrid/internal.js
  ...
  var ScrollGrid = class extends BaseComponent {
    ...
    renderSection(sectionConfig, sectionIndex, colGroupStats, microColGroupNodes, sectionRowMaxHeights, isHeader) {
      ...
      return y("tr", { key: sectionConfig.key, role: "presentation", className: getSectionClassNames(sectionConfig, this.props.liquid).join(" ") }, sectionConfig.chunks.map((chunkConfig, i3) => this.renderChunk(sectionConfig, sectionIndex, colGroupStats[i3], microColGroupNodes[i3], chunkConfig, i3, (sectionRowMaxHeights[sectionIndex] || [])[i3] || [], isHeader)));
    }
    renderChunk(sectionConfig, sectionIndex, colGroupStat, microColGroupNode, chunkConfig, chunkIndex, rowHeights, isHeader) {
      ...
      let index10 = sectionIndex * chunksPerSection + chunkIndex;
      ...
      let content = renderChunkContent(sectionConfig, chunkConfig, {
        tableColGroupNode: microColGroupNode,
        tableMinWidth,
        clientWidth: scrollerClientWidths[index10] !== void 0 ? scrollerClientWidths[index10] : null,
        clientHeight: scrollerClientHeights[index10] !== void 0 ? scrollerClientHeights[index10] : null,
        expandRows,
      ...
      content = y(ClippedScroller, { ref: this.clippedScrollerRefs.createRef(index10), scrollerElRef: this.scrollerElRefs.createRef(index10), overflowX, overflowY, forPrint: this.props.forPrint, liquid: chunkVGrow, maxHeight: sectionConfig.maxHeight }, content);
      return y(isHeader ? "th" : "td", {
        key: chunkConfig.key,
        ref: this.chunkElRefs.createRef(index10),
        role: "presentation"
      }, content);
    }
    componentDidMount() {
      ...
      for (let sectionI = 0; sectionI < sectionCnt; sectionI += 1) {
        ...
        if (sectionConfig && sectionConfig.syncRowHeights) {
          ...
          for (let chunkI = 0; chunkI < chunksPerSection; chunkI += 1) {
            let index10 = sectionI * chunksPerSection + chunkI;
            let rowHeights = [];
            let chunkEl = this.chunkElRefs.currentMap[index10];
            if (chunkEl) {
    ...
    computeScrollerDims() {
      ...
      let scrollerClientHeights = {};
      for (let sectionI = 0; sectionI < sectionCnt; sectionI += 1) {
        let index10 = sectionI * chunksPerSection + sideScrollI;
        let scroller = currentScrollers[index10];
        if (scroller && scroller.needsYScrolling()) {
          forceYScrollbars = true;
          break;
        }
      ...
      for (let chunkI = 0; chunkI < chunksPerSection; chunkI += 1) {
        let index10 = lastSectionI * chunksPerSection + chunkI;
        let scroller = currentScrollers[index10];
      ...
      for (let sectionI = 0; sectionI < sectionCnt; sectionI += 1) {
        for (let chunkI = 0; chunkI < chunksPerSection; chunkI += 1) {
          let index10 = sectionI * chunksPerSection + chunkI;
          let scrollerEl = scrollerEls[index10];
          if (scrollerEl) {
            let harnessEl = scrollerEl.parentNode;
            scrollerClientWidths[index10] = Math.floor(harnessEl.getBoundingClientRect().width - (chunkI === sideScrollI && forceYScrollbars ? scrollbarWidth.y : 0));
            scrollerClientHeights[index10] = Math.floor(harnessEl.getBoundingClientRect().height - (sectionI === lastSectionI && forceXScrollbars ? scrollbarWidth.x : 0));
          }
        }
      }
    ...
    getChunkConfigByIndex(index10) {
      let chunksPerSection = this.getDims()[1];
      let sectionI = Math.floor(index10 / chunksPerSection);
      let chunkI = index10 % chunksPerSection;
      let sectionConfig = this.props.sections[sectionI];
  ...
  // ../do_health/node_modules/@fullcalendar/timeline/internal.js
  ...
  function ensureLabelInterval(tDateProfile, dateProfile, dateEnv) {
    ...
    if (!labelInterval) {
      let input;
      if (tDateProfile.slotDuration) {
        for (input of STOCK_SUB_DURATIONS2) {
  ...
  function ensureSlotDuration(tDateProfile, dateProfile, dateEnv) {
    ...
    if (!slotDuration) {
      ...
      for (let input of STOCK_SUB_DURATIONS2) {
  ...
  var TimelineHeaderTh = class extends BaseComponent {
    ...
    render() {
      ...
      }, renderProps, generatorName: "slotLabelContent", customGenerator: options.slotLabelContent, defaultGenerator: renderInnerContent6, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => y(
        "div",
  ...
  function renderInnerContent6(renderProps) {
    return renderProps.text;
  }
  ...
  var TimelineHeaderRows = class extends BaseComponent {
    render() {
      ...
      return y(_, null, cellRows.map((rowCells, rowLevel) => {
        ...
        return y("tr", { key: rowLevel, className: classNames.join(" ") }, rowCells.map((cell) => y(TimelineHeaderTh, { key: cell.date.toISOString(), cell, rowLevel, dateProfile, tDateProfile, todayRange, nowDate, rowInnerHeight: rowInnerHeights && rowInnerHeights[rowLevel], isSticky: !isLast })));
      }));
    }
  };
  ...
  var TimelineHeader = class extends BaseComponent {
    ...
    render() {
      ...
      return y(NowTimer, { unit: timerUnit, unitValue: timerUnitValue }, (nowDate, todayRange) => y(
        ...
        context.options.nowIndicator && y("div", { className: "fc-timeline-now-indicator-container" }, slatCoords && slatCoords.isDateInRange(nowDate) && y(NowIndicatorContainer, { elClasses: ["fc-timeline-now-indicator-arrow"], elStyle: coordToCss(slatCoords.dateToCoord(nowDate), context.isRtl), isAxis: true, date: nowDate }))
      ));
    }
    componentDidMount() {
      this.updateSize();
  ...
  var TimelineSlatsBody = class extends BaseComponent {
    render() {
      ...
      return y(
        "tbody",
        null,
        y("tr", null, slotDates.map((slotDate, i3) => {
          let key = slotDate.toISOString();
          return y(TimelineSlatCell, { key, elRef: cellElRefs.createRef(key), date: slotDate, dateProfile: props.dateProfile, tDateProfile, nowDate: props.nowDate, todayRange: props.todayRange, isEm: isWeekStarts[i3], isDay });
        }))
      );
    }
  };
  var TimelineSlats = class extends BaseComponent {
    ...
    updateSizing() {
      let { props, context } = this;
      if (props.clientWidth !== null && this.scrollResponder) {
        let rootEl = this.rootElRef.current;
        if (rootEl.offsetWidth) {
          this.coords = new TimelineCoords(this.rootElRef.current, collectCellEls2(this.cellElRefs.currentMap, props.tDateProfile.slotDates), props.dateProfile, props.tDateProfile, context.dateEnv, context.isRtl);
          if (props.onCoords) {
  ...
  function collectCellEls2(elMap, slotDates) {
  ...
  function computeFgSegPlacements2(segs, segHCoords, eventInstanceHeights, moreLinkHeights, strictOrder, maxStackCnt) {
    let segInputs = [];
    let crudePlacements = [];
    for (let i3 = 0; i3 < segs.length; i3 += 1) {
      let seg = segs[i3];
  ...
  var TimelineEvent = class extends BaseComponent {
    render() {
      let { props } = this;
      return y(StandardEvent, Object.assign({}, props, { elClasses: ["fc-timeline-event", "fc-h-event"], defaultTimeFormat: DEFAULT_TIME_FORMAT3, defaultDisplayEventTime: !props.isTimeScale }));
    }
  };
  ...
  var TimelineLane = class extends BaseComponent {
    ...
    render() {
      ...
      let [fgPlacements, fgHeight] = computeFgSegPlacements2(fgSegs, fgSegHCoords, state.eventInstanceHeights, state.moreLinkHeights, options.eventOrderStrict, options.eventMaxStack);
    ...
    componentDidUpdate(prevProps, prevState) {
      if (prevProps.eventStore !== this.props.eventStore || prevProps.timelineCoords !== this.props.timelineCoords || prevState.moreLinkHeights !== this.state.moreLinkHeights) {
        this.updateSize();
      }
    }
    componentWillUnmount() {
    ...
    renderFgSegs(segPlacements, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
      ...
      return y(_, null, segPlacements.map((segPlacement) => {
        ...
        return y(
          ...
          y(TimelineEvent, Object.assign({ isTimeScale: props.tDateProfile.isTimeScale, seg, isDragging, isResizing, isDateSelecting, isSelected: instanceId === props.eventSelection }, getSegMeta(seg, props.todayRange, props.nowDate)))
        );
      }));
    }
  };
  ...
  // ../do_health/node_modules/@fullcalendar/resource-timeline/internal.js
  ...
  var SpreadsheetIndividualCell = class extends BaseComponent {
    constructor() {
      super(...arguments);
      this.refineRenderProps = memoizeObjArg(refineRenderProps4);
  ...
  function renderResourceInner(renderProps) {
    return renderProps.fieldValue || y(_, null, "\xA0");
  }
  function refineRenderProps4(input) {
    return {
      resource: new ResourceApi(input.context, input.resource),
  ...
  function renderGroupInner(renderProps) {
    return renderProps.groupValue || y(_, null, "\xA0");
  }
  var SpreadsheetRow = class extends BaseComponent {
    render() {
      ...
      return y("tr", { role: "row" }, props.colSpecs.map((colSpec, i3) => {
        ...
        if (rowSpan > 1) {
          return y(SpreadsheetGroupCell, { key: i3, colSpec, fieldValue, rowSpan });
        }
        return y(SpreadsheetIndividualCell, { key: i3, colSpec, resource, fieldValue, depth, hasChildren: props.hasChildren, isExpanded: props.isExpanded, innerHeight: props.innerHeight });
      }));
    }
  };
  ...
  var SpreadsheetHeader = class extends BaseComponent {
    ...
    render() {
      ...
      rowNodes.push(y("tr", { key: "row", role: "row" }, colSpecs.map((colSpec, i3) => {
        let isLastCol = i3 === colSpecs.length - 1;
        return y(ContentContainer, { key: i3, elTag: "th", elClasses: ["fc-datagrid-cell"], elAttrs: { role: "columnheader" }, renderProps, generatorName: "resourceAreaHeaderContent", customGenerator: colSpec.headerContent, defaultGenerator: colSpec.headerDefault, classNameGenerator: colSpec.headerClassNames, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, (InnerContent) => y(
          "div",
          ...
          !isLastCol && y("div", { className: "fc-datagrid-cell-resizer", ref: this.resizerElRefs.createRef(i3) })
        ));
      })));
      return y(_, null, rowNodes);
    }
    _handleColResizerEl(resizerEl, index10) {
      let { colDraggings } = this;
      if (!resizerEl) {
        let dragging = colDraggings[index10];
        if (dragging) {
          dragging.destroy();
          delete colDraggings[index10];
        }
      } else {
        let dragging = this.initColResizing(resizerEl, parseInt(index10, 10));
        if (dragging) {
          colDraggings[index10] = dragging;
        }
      }
    }
    initColResizing(resizerEl, index10) {
      ...
      if (ElementDraggingImpl) {
        ...
        dragging.emitter.on("dragstart", () => {
          ...
          startWidth = currentWidths[index10];
        });
        dragging.emitter.on("dragmove", (pev) => {
          currentWidths[index10] = Math.max(startWidth + pev.deltaX * (isRtl ? -1 : 1), SPREADSHEET_COL_MIN_WIDTH);
          if (onColWidthChange) {
  ...
  var ResourceTimelineView = class extends BaseComponent {
      ...
      this.handleScrollRequest = (request) => {
        ...
        if (rowCoords) {
          if (rowId) {
            ...
            let index10 = rowIdToIndex[rowId];
            if (index10 != null) {
              let scrollTop = request.fromBottom != null ? rowCoords.bottoms[index10] - request.fromBottom : rowCoords.tops[index10];
    ...
    renderSpreadsheetRows(nodes, colSpecs, rowSyncHeights) {
      return nodes.map((node, index10) => {
        if (node.group) {
          return y(SpreadsheetGroupRow, { key: node.id, id: node.id, spreadsheetColCnt: colSpecs.length, isExpanded: node.isExpanded, group: node.group, innerHeight: rowSyncHeights[index10] || "" });
        }
        if (node.resource) {
          return y(SpreadsheetRow, { key: node.id, colSpecs, rowSpans: node.rowSpans, depth: node.depth, isExpanded: node.isExpanded, hasChildren: node.hasChildren, resource: node.resource, innerHeight: rowSyncHeights[index10] || "" });
        }
        return null;
      });
    }
  ...
  // ../do_health/do_health/public/js/calendar.bundle.js
  frappe.FullCalendar = Calendar;
  frappe.FullCalendar.Plugins = [index2, index, index3, index4, index7, index9];
})();
//# sourceMappingURL=calendar.bundle.VHRYQOG6.js.map
